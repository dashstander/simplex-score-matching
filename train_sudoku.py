...
def calc_val_metrics(
    ...
    num_solved_puzzles.append(correct_puzzles)
    pcnt_solved_puzzles.append(batch_puzzle_pcnt)
    num_correct_vals.append(correct_vals)
    pcnt_correct_vals.append(batch_val_pcnt)
    masked_entropies.append(batch_masked_ent)
    unmasked_entropies.append(batch_unmasked_ent)
...
def make_solver(config):
    ...
    def solve_fn(params, rng, x_final, mask, t_final):
